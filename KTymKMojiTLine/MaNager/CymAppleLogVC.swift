...
extension APPleloGinVC {
    func setupView() {
        ...
        let topBgImgV = UIImageView(image: UIImage(named: "red_left_ic"))
        topBgImgV.contentMode = .scaleAspectFill
        view.addSubview(topBgImgV)
        topBgImgV.snp.makeConstraints {
            $0.top.equalToSuperview()
            $0.left.equalToSuperview()
            $0.width.equalTo(350/2)
            $0.height.equalTo(420/2)
        }
        let bottomBgImgV = UIImageView(image: UIImage(named: "blue_right_ic"))
        bottomBgImgV.contentMode = .scaleAspectFill
        view.addSubview(bottomBgImgV)
        bottomBgImgV.snp.makeConstraints {
            $0.bottom.equalToSuperview()
            $0.right.equalToSuperview()
            $0.width.equalTo(372/2)
            $0.height.equalTo(486/2)
        }
         
        //
        let closebutton = UIButton()
        closebutton.alpha = 1
        closebutton.setImage(UIImage(named: "log_in_close_jic"), for: .normal)
        ...
        topTitleLabe.font = UIFont(name: "Lexend-Bold", size: 28)
        topTitleLabe.adjustsFontSizeToFitWidth = true
        topTitleLabe.textAlignment = .center
        topTitleLabe.textColor = UIColor(hexString: "#000000")
        topTitleLabe.text = "WoW help you get a New Look in Seconds!"
        ...
        //
        let userInfoImgV = UIImageView(image: UIImage(named: "log_in_logo"))
        view.addSubview(userInfoImgV)
        userInfoImgV.contentMode = .scaleAspectFit
        userInfoImgV.snp.makeConstraints {
            $0.centerX.equalToSuperview()
            $0.width.equalTo(118/2)
            $0.height.equalTo(150/2)
            $0.bottom.equalTo(topTitleLabe.snp.top).offset(-25)
...
//        }
        ...
        str.addAttributes([NSAttributedString.Key.underlineStyle: number,
                           NSAttributedString.Key.foregroundColor: UIColor.init(hexString: "#000000")?.withAlphaComponent(0.8) ?? .white,
